 ...
 */
class Config extends \App\Models\Entity\Config implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Models\\Entity\\Config' . "\0" . 'id', '' . "\0" . 'App\\Models\\Entity\\Config' . "\0" . 'key', '' . "\0" . 'App\\Models\\Entity\\Config' . "\0" . 'value', '' . "\0" . 'App\\Models\\Entity\\Config' . "\0" . 'active'];
        }

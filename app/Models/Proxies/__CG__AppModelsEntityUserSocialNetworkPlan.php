 ...
 */
class UserSocialNetworkPlan extends \App\Models\Entity\UserSocialNetworkPlan implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Models\\Entity\\UserSocialNetworkPlan' . "\0" . 'id', '' . "\0" . 'App\\Models\\Entity\\UserSocialNetworkPlan' . "\0" . 'dateStart', '' . "\0" . 'App\\Models\\Entity\\UserSocialNetworkPlan' . "\0" . 'dateEnd', '' . "\0" . 'App\\Models\\Entity\\UserSocialNetworkPlan' . "\0" . 'socialNetworkPlan', '' . "\0" . 'App\\Models\\Entity\\UserSocialNetworkPlan' . "\0" . 'userSocialNetwork'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserSocialNetworkPlan $proxy) {

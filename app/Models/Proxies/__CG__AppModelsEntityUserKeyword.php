 ...
 */
class UserKeyword extends \App\Models\Entity\UserKeyword implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Models\\Entity\\UserKeyword' . "\0" . 'id', '' . "\0" . 'App\\Models\\Entity\\UserKeyword' . "\0" . 'keyword', '' . "\0" . 'App\\Models\\Entity\\UserKeyword' . "\0" . 'dateCreated', '' . "\0" . 'App\\Models\\Entity\\UserKeyword' . "\0" . 'dateModified', '' . "\0" . 'App\\Models\\Entity\\UserKeyword' . "\0" . 'user'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserKeyword $proxy) {

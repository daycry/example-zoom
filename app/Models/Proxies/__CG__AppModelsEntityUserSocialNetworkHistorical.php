 ...
 */
class UserSocialNetworkHistorical extends \App\Models\Entity\UserSocialNetworkHistorical implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Models\\Entity\\UserSocialNetworkHistorical' . "\0" . 'id', '' . "\0" . 'App\\Models\\Entity\\UserSocialNetworkHistorical' . "\0" . 'followers', '' . "\0" . 'App\\Models\\Entity\\UserSocialNetworkHistorical' . "\0" . 'friends', '' . "\0" . 'App\\Models\\Entity\\UserSocialNetworkHistorical' . "\0" . 'dateCreated', '' . "\0" . 'App\\Models\\Entity\\UserSocialNetworkHistorical' . "\0" . 'userSocialNetwork'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserSocialNetworkHistorical $proxy) {
    ...
    public function setFollowers($followers)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFollowers', [$followers]);

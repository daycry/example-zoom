 ...
 */
class UserBlacklist extends \App\Models\Entity\UserBlacklist implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Models\\Entity\\UserBlacklist' . "\0" . 'id', '' . "\0" . 'App\\Models\\Entity\\UserBlacklist' . "\0" . 'keyword', '' . "\0" . 'App\\Models\\Entity\\UserBlacklist' . "\0" . 'dateCreated', '' . "\0" . 'App\\Models\\Entity\\UserBlacklist' . "\0" . 'dateModified', '' . "\0" . 'App\\Models\\Entity\\UserBlacklist' . "\0" . 'user'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserBlacklist $proxy) {

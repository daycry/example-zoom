 ...
 */
class UserSocialNetworkNotification extends \App\Models\Entity\UserSocialNetworkNotification implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Models\\Entity\\UserSocialNetworkNotification' . "\0" . 'id', '' . "\0" . 'App\\Models\\Entity\\UserSocialNetworkNotification' . "\0" . 'message', '' . "\0" . 'App\\Models\\Entity\\UserSocialNetworkNotification' . "\0" . 'description', '' . "\0" . 'App\\Models\\Entity\\UserSocialNetworkNotification' . "\0" . 'dateCreated', '' . "\0" . 'App\\Models\\Entity\\UserSocialNetworkNotification' . "\0" . 'userSocialNetwork'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserSocialNetworkNotification $proxy) {
